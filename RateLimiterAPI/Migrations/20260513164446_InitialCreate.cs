        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateLimit = table.Column<int>(type: "int", nullable: false, defaultValue: 100),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Scopes = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "read"),
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Description", "IsActive", "Name", "Price", "RequestsPerMinute" },
                values: new object[,]
                {
                    { 1, "Perfect for small projects and testing.", true, "Free", 0m, 100 },
                    { 2, "For growing applications and teams.", true, "Pro", 29m, 1000 },
                    { 3, "Unlimited access for large scale applications.", true, "Enterprise", 199m, 999999 }
                });
